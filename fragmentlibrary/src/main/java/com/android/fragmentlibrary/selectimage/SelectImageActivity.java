...
import com.android.fragmentlibrary.util.StatusBarUtil;

import java.util.ArrayList;

/**
 * @author Created by freed
 * Created by freed on 2019/2/17.
 * Date:2019/2/17
 * @description
 */
public class SelectImageActivity extends BaseSkipActivity implements View.OnClickListener {
    // 带过来的Key
    // 是否显示相机的EXTRA_KEY
    ...
    private TextView mSelectNumTv,mSelectPreview;
    ...
    public void initView() {
        mImageListRv= viewById(R.id.image_list_rv);
        mSelectNumTv =viewById(R.id.select_num);
        mSelectPreview=viewById(R.id.select_preview);
    }
    ...
    public void initTitle() {
        ...
        DefaultNavigationBar navigationBar = new
                DefaultNavigationBar.Builder(SelectImageActivity.this,parent)
                .setTitle("所有图片")
                .builer();
        //改变状态栏颜色
    ...
    public void initListener() {
        viewById(R.id.select_finish).setOnClickListener(new View.OnClickListener() {
            @Override
